...
<?php if ($_SESSION['login'] === 'active') { ?>
                              ...
                              <div class="tab-content" id="myTabContent">
                                   <div class="tab-pane cilent_type fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        ...
                                        <ul class="users_items_name">
                                             <?php foreach (GetAll('user', 'false', 'asc') as $key => $user) : ?>
                                                  ...
                                                  $date1_oltioy = new DateTime($user['oltiOy']);
                                                  $date2 = new DateTime(date('Y-m-d')); // bungungi sanan

                                                  $interval = $date1->diff($date2); //3 oy
                                                  $interval_oltioy = $date1_oltioy->diff($date2); // 6oy

                                                  if ($date1 <= $date2) {
                                                       $days_m_3 =  '- ' . $interval->days;
                                                  } else {
                                                       $days_m_3 =  $interval->days;
                                                  }

                                                  if ($date1_oltioy <= $date2) {
                                                       $days_m_6 =  '- ' . $interval_oltioy->days;
                                                  } else {
                                                       $days_m_6 =  $interval_oltioy->days;
                                                  }
                                                  ...
                                                  if ($user['bool'] == 'true') {
                                                       $chek_xizmat = 'active';
                                                       $chek_text = 'fa-solid fa-check';
                                                       $days_m_3 = ' ';
                                                  } else {
                                                       $chek_text = ' ';
                                                       $chek_xizmat = 'noactive';
                                                  }
                                                  if ($user['bool2'] == 'true') {
                                                       $chek_xizmat2 = 'active';
                                                       $chek_text_6 = 'fa-solid fa-check';
                                                       $days_m_6 = ' ';
                                                  } else {
                                                       $chek_text_6 = ' ';
                                                       $chek_xizmat2 = 'noactive';
                                                  }
                                                  ...
                                                  <li>
                                                       <form action="<?= $config['base']['url'] . 'server.php' ?>" method="get">
                                                            ...
                                                            <button class="user_id_about_a btn_user_about" type="submit" value="ok" name="user_about">
                                                                 ...
                                                                 <div class="user_date">
                                                                      <p><?= $user['date'] ?></p>
                                                                      <p class="<?= $chek_xizmat . ' ' . $chek_text ?>" title=" kunda xizmat ko'rsatish kerak"><?= $days_m_3 ?></p>
                                                                      <p class="<?= $chek_xizmat2 . ' ' . $chek_text_6 ?>" title=" kunda xizmat ko'rsatish kerak"><?= $days_m_6 ?></p>
                                                                 </div>
                                                            </button>
                                                       </form>
                                                  </li>
                                   ...
                                   <div class="tab-pane fade cilent_type" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                        ...
                                        <ul class="users_items_name users_items_name2">
                                             <?php if ($date1 <= $date2 || $date1_oltioy <=  $date2) { ?>
                                                  <?php foreach (GetAll('user', 'false', 'asc') as $key => $user) : ?>
                                                       <?php
                                                       if ($date1 <= $date2 && $user['bool'] == 'false') {
                                                       ?>
                                                            <li>
                                                                 <form action="<?= $config['base']['url'] . 'server.php' ?>" method="get">
                                                                      <input type="hidden" required class="user_id" value="<?= $user['id'] ?>">
                                                       ...
                                                       <?php
                                                       } else if ($date1_oltioy <=  $date2 && $user['bool2'] == 'false') {
                                                       ?>
                                                            <li>
                                                                 <form action="<?= $config['base']['url'] . 'server.php' ?>" method="get">
                                                                      <input type="hidden" required class="user_id" value="<?= $user['id'] ?>">
                                   ...
                                   <div class="tab-pane fade cilent_type" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                                        ...
                                        <ul class="users_items_name users_items_name3">
                                             <?php foreach (GetAll('user', 'false', 'asc') as $key => $user) : ?>
                                                  <?php
                                                  if ($user['miqdorSum'] != 'null' && $user['bool_q'] == 'false') {
                                                       ...
                                                       if ($date1_q <= $date2_q) {
                                                            $days_m_q =  '- '.$interval_q->days;
                                                       } else {
                                                            $days_m_q =  $interval_q->days;
                                                       }
                                                       if ($user['bool_q'] == 'true') {
                                                            $chek_xizmat2_q = 'active';
                                                            $chek_text_q = 'fa-solid fa-check';
                                                            $days_m_q = ' ';
                                                       } else {
                                                            $chek_text_q = ' ';
                                                            $chek_xizmat2_q = 'noactive';
                                                       }
                                                  ?>
                                                       <li>
                                                            <form action="<?= $config['base']['url'] . 'server.php' ?>" method="get">
                                                                 ...
                                                                 <button class="user_id_about_a btn_user_about" type="submit" value="ok" name="user_about">
                                                                      ...
                                                                      <div class="user_date">
                                                                           <p class="qarz_paq_user <?= $chek_xizmat2_q.' '.$chek_text_q?>" title=""><?= $days_m_q ?></p>
                                                                      </div>
                                                                 </button>
                                                            </form>
                                                       </li>
                                   ...
                                   <div class="tab-pane fade cilent_type" id="contact2" role="tabpanel" aria-labelledby="contact-tab">
                                        ...
                                        <ul class="users_items_name users_items_name4">
                                             <?php foreach (GetAll('user', 'false', 'asc') as $key => $user) : ?>
                                                  <?php if ($user['miqdorSum'] != 'null' && $user['bool_q'] == 'false') { ?>
     ...
     if (isset($_POST['bool_add'])) {
          ...
          if (empty($_POST['chek2'])) {
               $chek2 = 'false';
          } else {
               $chek2 = 'true';
          }
          if (empty($_POST['qarz_sanas'])) {
               $qarz_sanas = 'null';
          } else {
               $qarz_sanas = $_POST['qarz_sanas'];
          }
          $db = connection();
     ...
     if (isset($_POST['cilentAdd'])) {
          if (
               ...
               if ((isset($_POST['miqdor']) && !empty($_POST['miqdor'])) && isset($_POST['qarz_vaqt']) && !empty($_POST['qarz_vaqt'])) {
                    ...
                    $bool_q = 'false';
                    $qarzYopilganSana = 'null';
               } else {
                    $s_miqdor = 'null';
                    $qarz_vaqt = 'null';
                    $bool_q = 'true';
                    $qarzYopilganSana = "Qarzdorlik yo'q";
               }
               ...
               $threeMonthsLater1 = clone $today; // Bugungi sanani nusxalash
               $threeMonthsLater1->modify('+6 months');
               $olti_oy = $threeMonthsLater1->format('Y-m-d') . "\n";
